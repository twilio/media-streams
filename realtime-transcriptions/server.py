...
class SheechToTextBridge:
    ...
    def getRequests(self):
        ...
        return
    def printResponses(self, responses):
        self._thread = Thread(target=self.listen_print_loop, args=[responses])
        self._thread.start()
...
def pcmu(ws):
    ...
    bridge = SheechToTextBridge()
    responses = client.streaming_recognize(streaming_config, bridge.getRequests())
    bridge.printResponses(responses)
